...
Execute na ordem; TODOS os passos aplicáveis precisam passar. Os comandos exatos de build/lint/teste estão em `DOC/08-OPERACAO.md` (e no `CLAUDE.md` §Comandos).
